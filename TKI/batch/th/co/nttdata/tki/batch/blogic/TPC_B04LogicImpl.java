...
import th.co.nttdata.tki.batch.bean.TpicsXCust;

import com.ibatis.sqlmap.client.SqlMapClient;

@Service("TPC_B04")
public class TPC_B04LogicImpl extends BatchLogicImpl {
	
	private static final String BATCH_CODE = "TPC_B04";
	private static final String BATCH_NAME = "TPICS - Customer";
	...
	public void processing() throws Exception {
		log.info("-----Start TPC_B04 xcust-----");
		// delete tpics_workorder
		sqlMap.delete("tpics_xcust_batch.delete");
		// select v_tnps_cust_fg_part (TPics)
		TpicsXCust w = new TpicsXCust();
		w.setXcustList(sqlMapTpics.queryForList("xcust_batch.query"));
		// insert tpics_cust_fg_part
		for(TpicsXCust c : w.getXcustList()){
			sqlMap.insert("tpics_xcust_batch.insert",c);
		}
