...
//			createMergedRegion(sheet, rowNumber, rowNumber+1, 4, 4);
			...
			if( (currDetail != nextDetail) && currDetail.getDatailRef().equals(nextDetail.getDatailRef()) ) {
				...
				createCell(workbook, fstRow, 6, r01c07Style).setValue(currDetail.getOk());
				createCell(workbook, fstRow, 7, r01c08Style).setValue(currDetail.getNg());
				createCell(workbook, fstRow, 8, r01c09Style).setValue(currDetail.getPd());
				createCell(workbook, fstRow, 9, r01c10Style).setValue(new Integer[] { currDetail.getOk(), currDetail.getNg(), currDetail.getPd() });
				Cell c11 = createCell(workbook, fstRow, 10, r01c11Style);
				Cell c12 = createCell(workbook, fstRow, 11, r01c12Style);
				Cell cLossTime = createCell(workbook, fstRow, 12, r01c12Style);
				Cell cLossTimeReason = createCell(workbook, fstRow, 13, r01c12Style);
				Cell cWorker = createCell(workbook, fstRow, 14, r01c12Style);
				Cell c13 = createCell(workbook, fstRow, 15, r01c13Style);
				Cell c14 = createCell(workbook, fstRow, 16, r01c14Style);
				Cell c15 = createCell(workbook, fstRow, 17, r01c15Style);
				Cell c16 = createCell(workbook, fstRow, 18, r01c16Style);
				...
				createCell(workbook, sndRow, 10, r02c11Style);
				createCell(workbook, sndRow, 11, r02c12Style);
				createCell(workbook, sndRow, 12, r02c12Style);
				createCell(workbook, sndRow, 13, r02c12Style);
				createCell(workbook, sndRow, 14, r02c12Style);
...
//				createMergedRegion(sheet, rowNumber, rowNumber+1, 12, 12);
				...
				cLossTime.setValue(new Integer[] { currDetail.getLossTime(), nextDetail.getLossTime() });
				cLossTimeReason.setValue(currDetail.getLossTimeReasonName());
				cWorker.setValue(currDetail.getStaff());
...
//				createMergedRegion(sheet, rowNumber, rowNumber+1, 16, 16);
				...
				if( (currDetail.getShift().equals("D") && nextDetail.getShift().equals("D")) || (currDetail.getShift().equals("D") && nextDetail.getShift().equals("N")) ) {
					...
					createCell(workbook, sndRow,  6, r02c07Style);
					createCell(workbook, sndRow,  7, r02c08Style);
					createCell(workbook, sndRow,  8, r02c09Style);
					createCell(workbook, sndRow, 9, r02c10Style);
					createCell(workbook, sndRow, 10, r02c11Style);
					createCell(workbook, sndRow, 11, r02c12Style);
					createCell(workbook, sndRow, 12, r02c12Style);
					createCell(workbook, sndRow, 13, r02c12Style);
...
//					createMergedRegion(sheet, rowNumber, rowNumber+1, 12, 12);
					...
					cLossTime.setValue(currDetail.getLossTime());
					cLossTimeReason.setValue(currDetail.getLossTimeReasonName());
					cWorker.setValue(currDetail.getStaff());
...
//					createMergedRegion(sheet, rowNumber, rowNumber+1, 16, 16);
				...
				if( (currDetail.getShift().equals("N") && nextDetail.getShift().equals("D")) || (currDetail.getShift().equals("N") && nextDetail.getShift().equals("N")) ) {
					...
					createCell(workbook, fstRow, 6, r01c07Style);
					createCell(workbook, fstRow, 7, r01c08Style);
					createCell(workbook, fstRow, 8, r01c09Style);
					createCell(workbook, fstRow, 9, r01c10Style);
					Cell c11 = createCell(workbook, fstRow, 10, r01c11Style);
					Cell c12 = createCell(workbook, fstRow, 11, r01c12Style);
					Cell cLossTime = createCell(workbook, fstRow, 12, r01c12Style);
					Cell cLossTimeReason = createCell(workbook, fstRow, 13, r01c12Style);
					...
					createCell(workbook, sndRow, 6, r02c07Style).setValue(currDetail.getOk());
					createCell(workbook, sndRow, 7, r02c08Style).setValue(currDetail.getNg());
					createCell(workbook, sndRow, 8, r02c09Style).setValue(currDetail.getPd());
					createCell(workbook, sndRow, 9, r02c10Style).setValue(new Integer[] { currDetail.getOk(), currDetail.getNg(), currDetail.getPd() });
					createCell(workbook, sndRow, 10, r02c11Style);
					createCell(workbook, sndRow, 11, r02c12Style);
					createCell(workbook, sndRow, 12, r02c12Style);
					createCell(workbook, sndRow, 13, r02c12Style);
