  ...
  function CheckboxSelectColumn(options) {
    ...
    function handleSelectedRowsChanged(e, args) {
      ...
      if (selectedRows.length == _grid.getDataLength()) {
        _grid.updateColumnHeader(_options.columnId, "<input type='checkbox' checked='checked'  id='slickGridChkAll'> ", _options.toolTip);
      } else {
        _grid.updateColumnHeader(_options.columnId, "<input type='checkbox'  id='slickGridChkAll'> ", _options.toolTip);
      }
    }
