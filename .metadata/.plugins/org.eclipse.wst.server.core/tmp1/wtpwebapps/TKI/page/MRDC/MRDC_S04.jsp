...
<script language="javascript">
	...
	$(document).ready(function(){
		...
		mrdc_s04Form= $("form#mrdc_s04Form");
		
		btnExport.click(function(){
			/*var errors = [];
			if( customerId.val() < 0 && category.val() == "" && partNo.val() == "" && partName.val() == "")
			...
			if (message.isNoError()) {
				...
				getJSON("MRDC_R04_export_count", $.param(params), function( result ){
					...
					mrdc_s04Form.attr("action","MRDC_R04_export.html");
					mrdc_s04Form.submit();
				});
				return false;
			}
...
<body>
	<h1 class="header"><spring:message code='menu.ProductMaster'/></h1>
	<page:message item="${deliveryPlan}" />
	<form:form id="mrdc_s04Form" method="post" action="MRDC_R04_export.html" commandName="deliveryPlan">
